...
// Mobile menu functionality - Full-screen overlay with accessibility
function initMobileMenu() {
  try {
    // Support both old data-attribute and new ID-based selectors
    const mobileMenuButton = document.getElementById('mobile-menu-toggle') || document.querySelector('[data-mobile-menu-toggle]');
    ...
    if (mobileMenuButton && mobileMenu) {
      ...
      // Close when clicking a menu link (navigation)
